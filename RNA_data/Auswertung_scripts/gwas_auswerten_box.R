...
if(i %in% which(genes_high_all %in% tair10$Gene)){
	thresh <- read.csv(paste("~/RNA/GWAS_perm_boxcox/", i, "/perm_results.csv",sep=""))[5,3]
  ...
  save(RNA_results_perm, file=paste("~/RNA/RNA_boxcox_results/RNA_results_perm_boxcox",i,".rda",sep=""))
}
